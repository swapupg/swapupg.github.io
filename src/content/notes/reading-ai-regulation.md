...
number: 4
sources:
  - title: 'European Commission: AI Omnibus enters into force, 27 July 2026'
    url: https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force
  - title: 'European Commission: AI Act enforcement and transparency, 31 July 2026'
  ...
  - title: 'European Commission: Article 50 transparency obligations FAQ'
    url: https://digital-strategy.ec.europa.eu/en/faqs/transparency-obligations-under-article-50-ai-act
  - title: 'EUR-Lex: Regulation (EU) 2024/1689, original AI Act'
...
**Guidance and voluntary frameworks** can help interpretation or risk management, but their status matters. NIST describes its [AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework) as voluntary. Using it is not equivalent to satisfying every applicable legal requirement.

## A dated EU example

The Commission’s [July 2026 announcement](https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force) says the AI Omnibus entered into force on 27 July 2026. It reports extended application dates for Annex III high-risk systems to 2 December 2027, and specified AI embedded in Annex I products to 2 August 2028. Older summaries of the original timeline can therefore be misleading.

Separately, the Commission [announced enforcement and new transparency requirements from 2 August 2026](https://digital-strategy.ec.europa.eu/en/news/commission-starts-enforcing-ai-act-rules-and-new-transparency-requirements-2-august). Its [Article 50 FAQ](https://digital-strategy.ec.europa.eu/en/faqs/transparency-obligations-under-article-50-ai-act) discusses the relevant transparency duties and a limited transition for certain pre-existing systems under Article 50(2). That transition should not be generalized to every transparency obligation.

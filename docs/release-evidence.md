...
- Tests caught a native-reset timing issue before release; reset now synchronously restores defaults and hides comparison/results. The no-script explanation was directly inspected and checked through its rendered paragraph.

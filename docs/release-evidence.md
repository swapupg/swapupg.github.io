...
- Linux Chrome CI caught overlapping smooth fragment scrolls during successive article-section navigation. Section links now use native immediate scrolling; the original viewport assertions remain in place. The failed candidate was not deployed.
